package com.imotiongames.ratingdialog;
...
import com.imotiongames.ratingdialog.databinding.DialogBinding;
...
public class MyAppRating {
    ...
    private int minNumberOfStars = 4;
    ...
    public void rateNow() {
        if (callback != null) {
            ...
            if (ratingBar != null) {
                if (ratingBar.getRating() >= minNumberOfStars) {
    ...
    public void openEmail() {
        ...
        emailIntent.putExtra(Intent.EXTRA_EMAIL,new String[] {"imotionbox@gmail.com"});
    ...
    public void tryShow(Context context, String title, String rateNowText, String reminedMeLaterText, String noThanksText, int backGroundColor) {
        if (isShowing())
            return;
        try {
            dialog = null;
